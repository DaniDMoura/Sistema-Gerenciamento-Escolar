...
def upgrade() -> None:
    ...
    sa.Column('data_admissao', sa.Date(), server_default=sa.text('now()'), nullable=False),
    ...
    op.create_index(op.f('ix_Professores_email'), 'Professores', ['email'], unique=False)
    op.create_index(op.f('ix_Professores_nome'), 'Professores', ['nome'], unique=False)
    op.create_index(op.f('ix_Professores_sobrenome'), 'Professores', ['sobrenome'], unique=False)
    op.create_index(op.f('ix_Professores_telefone'), 'Professores', ['telefone'], unique=False)
    ...
    op.create_index(op.f('ix_Responsaveis_sobrenome'), 'Responsaveis', ['sobrenome'], unique=False)
    ...
    sa.ForeignKeyConstraint(['id_professor'], ['Professores.id_professor'], ),
    sa.ForeignKeyConstraint(['id_turma'], ['Turmas.id_turma'], ),
    ...
    sa.Column('id_responsavel', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['id_responsavel'], ['Responsaveis.id_responsavel'], ),
    ...
    op.create_index(op.f('ix_Alunos_sobrenome'), 'Alunos', ['sobrenome'], unique=False)
    ...
    sa.Column('data_lancamento', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['id_aluno'], ['Alunos.id_aluno'], ),
    sa.ForeignKeyConstraint(['id_disciplina'], ['Disciplinas.id_disciplina'], ),
